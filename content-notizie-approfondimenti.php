...
?>
          <!-- main-content -->
          <div class="col-md-6 col-sm-12 col-md-pull-3 floatright content secondary notizie approfondimenti">
            <section class="notizie approfondimenti index">
              ...
              <article class="index first">
                ...
                <h2>
                  <a href="tpl-notizie-approfondimenti-dettaglio.php">
                    Lorem ipsum
                  </a>
                </h2>
